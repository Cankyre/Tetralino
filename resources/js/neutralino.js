var Neutralino = (function (e) {
      ...
      (t.request = function (e) {
        return new Promise((t, n) => {
          ...
          (o.onreadystatechange = () => {
            ...
            "GET" == e.type &&
              (o.open("GET", e.url, !0),
              o.setRequestHeader("Authorization", "Basic " + window.NL_TOKEN),
              o.send()),
            "POST" == e.type &&
              (o.open("POST", e.url, !0),
              o.setRequestHeader(
  ...
  function (e, t, n) {
    ...
    !(function (e) {
      (e.WARN = "WARN"),
        ...
        (e.INFO = "INFO"),
        (e.QUESTION = "QUESTION");
    })(t.MessageBoxType || (t.MessageBoxType = {})),
  ...
  function (e, t, n) {
    ...
    t.init = function () {
      if (
        (window.NL_MODE && "browser" == window.NL_MODE && i.ping.start(),
        void 0 !== window.NL_ARGS)
      )
        for (let e = 0; e < window.NL_ARGS.length; e++)
          if ("--debug-mode" == window.NL_ARGS[e]) {
            o.devClient.start();
            break;
          }
    };
